...
function(o) {
    ...
    t.prototype.initCharts = function() {
        ...
        // new ApexCharts(document.querySelector("#today-revenue-chart"), t).render(), new ApexCharts(document.querySelector("#today-product-sold-chart"), o.extend({}, t, {
        //     colors: ["#f77e53"]
        // })).render(), new ApexCharts(document.querySelector("#today-new-customer-chart"), o.extend({}, t, {
        //     colors: ["#43d39e"]
        // })).render(), new ApexCharts(document.querySelector("#today-new-visitors-chart"), o.extend({}, t, {
        //     colors: ["#ffbe0b"]
        // })).render();
        var e = new Date,
            r = {
